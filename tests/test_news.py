...
def test_admin_can_create_announcement(client, app):
    ...
    r = client.post("/news/new", data={
        "title": "تعميم", "category": "announcement",
        "body": "نص التعميم", "is_published": "y",
...
def test_pinned_sorts_first(client, app):
    login(client)
    client.post("/news/new", data={"title": "قديم", "category": "news",
                                    "body": "x", "is_published": "y"})
    client.post("/news/new", data={"title": "مثبت", "category": "news",
                                    "body": "y", "is_published": "y", "pinned": "y"})
...
def test_category_filter(client, app):
    login(client)
    client.post("/news/new", data={"title": "فعالية اليوم", "category": "event",
                                    "body": "z", "is_published": "y"})
